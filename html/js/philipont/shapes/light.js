  ...
  getColor() {
    if (this.directional) {
      ...
      return vec3.fromValues(
        (1 - this.yCoeff[0]) + this.yCoeff * this.position[1] * this.color[0],
        (1 - this.yCoeff[1]) + this.yCoeff * this.position[1] * this.color[1],
        (1 - this.yCoeff[2]) + this.yCoeff * this.position[1] * this.color[2],
      );
    }
    return this.color;
  }
